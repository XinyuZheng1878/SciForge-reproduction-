...
} from '../mcp/sciforge-canvas-mcp-config'
import {
  buildPptMasterMcpConfigFragment,
  type PptMasterMcpLaunchConfig
} from '../mcp/ppt-master-mcp-config'
import {
  getScientificPlottingStatus,
  prepareScientificPlottingReference
} from '../../../workers/scientific-plotting/src/scientific-plotting-engine'
import {
...
} from '../../../workers/canvas/src/sciforge-canvas-engine'
import {
  buildScientificSkillsIndex,
  buildScientificSkillsStatusSummary
} from '../../../workers/scientific-plotting/src/scientific-skills-index'
import {
  installScientificSkills,
  type ScientificSkillsInstallRequest,
  type ScientificSkillsInstallResult
} from '../../../workers/scientific-plotting/src/scientific-skills-installer'
import {
  evaluateFigureStyleSimilarity,
  extractFigureStyle,
  reviewFigureStyleOutput
} from '../../../workers/scientific-plotting/src/figure-style-extractor'
import type {
...
import {
  ...
  evidenceDagUiUrl
} from '../../../workers/evidence-dag/desktop/contract'
import type {
...
import type { RemoteChannelRuntime } from '../remote/remote-channel-runtime'
import type { DiscordBotRuntime } from '../remote/discord-bot-runtime'
