...
import { composerReferenceFromWorkspaceReference } from '../../../../frontend/lib/workspace-reference-composer'
import { buildComposerFileContextPrompt } from '../../../../frontend/lib/composer-file-references'
import { readComposerFileContextEntries } from '../../../../frontend/lib/composer-file-context'
import {
  createSettingsMemoryActions,
  type SettingsMemoryRecord,
  type SettingsMemoryRecordUpdater
} from '../../../../frontend/lib/settings-memory-actions'
...
describe('AgentRuntimeHost', () => {
    ...
    await host.auxiliary({
      ...
      payload: {
        ...
        patch: {
          ...
          fileReferences: [{
            workspaceRoot: '/tmp/workspace',
            relativePath: 'backend/main/runtime/agent-runtime/host.ts',
            name: 'host.ts',
            kind: 'file'
          }],
  ...
  it('injects bounded runtime context ledger constraints into same-runtime continuation turns', async () => {
    ...
    expect(dispatched?.text).toContain('backend/main/runtime/agent-runtime/host.ts')
