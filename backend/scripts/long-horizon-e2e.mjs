...
const tasks = [
  ...
  },
  {
    ...
    files: {
      'frontend/components/Workbench.tsx': `// fixture: Workbench owns composer state, mode switching, and sendPlanTurn.\n`,
      'frontend/components/chat/FloatingComposer.tsx': `// fixture: FloatingComposer renders the plan-mode toggle.\n`,
      'frontend/components/workbench-plan-controller.ts': `// fixture: sendPlanTurn creates GUI plan context and opens PlanPanel.\n`
    }
  },
  {
    ...
    files: {
      'runtime/src/adapters/tool/capability-registry.ts': `// fixture: plan mode allowed tool names are filtered here.\n`,
      'runtime/src/adapters/tool/local-tool-host.ts': `// fixture: request_user_input and create_plan are registered here.\n`,
      'runtime/tests/agent-loop-sandbox.test.ts': `// fixture: sandbox policy tests live here.\n`
    }
  },
  {
    ...
    files: {
      'backend/shared/long-horizon-prompt.ts': `// fixture: plan-mode policy and question triage live here.\n`,
      'frontend/plan/plan-prompts.ts': `// fixture: GUI plan prompts should mention request_user_input and create_plan.\n`
    }
  },
  {
    ...
    files: {
      'frontend/components/settings/README.md': `# Settings area\nSettings pages share i18n keys, keyboard navigation, and existing auth state.\n`,
      'frontend/locales/en/common.json': `{"settings":"Settings"}\n`,
      'frontend/locales/zh/common.json': `{"settings":"设置"}\n`
    }
  },
  {
    ...
    files: {
      ...
      'backend/main/index.ts': `// fixture: main process imports local runtime and SDK-backed adapters.\n`
    }
  },
  {
    ...
    files: {
      'runtime/src/adapters/file/schema.sql': `CREATE TABLE sessions (id TEXT PRIMARY KEY, title TEXT, created_at TEXT NOT NULL);\n`,
  ...
  },
  {
    ...
    files: {
      'workers/research-memory/src/index.ts': `// fixture: worker entry point for research-memory sync.\n`,
      'frontend/stores/research-memory.ts': `// fixture: renderer state should stay responsive while sync runs.\n`,
  ...
  },
  {
    ...
    files: {
      'workers/scientific-plotting/src/index.ts': `// fixture: plotting worker exports figure generation APIs.\n`,
  ...
  },
  {
    ...
    files: {
      'workers/multi-agent/src/index.ts': `// fixture: multi-agent worker can coordinate bounded sub-agent jobs.\n`,
...
async function loadPromptBuilder() {
  ...
  execFileSync(
    ...
    [
      ...
      '--outDir',
      compiledRoot,
      'backend/shared/long-horizon-prompt.ts'
    ],
