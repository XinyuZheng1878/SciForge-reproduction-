...
const PACKAGE_DEFINITIONS = {
  modelRouter: {
    dir: 'workers/model-router'
  },
  schedule: {
    dir: 'workers/schedule'
  },
  search: {
    dir: 'workers/search'
  },
  workflow: {
    dir: 'workers/workflow'
  },
  workspaceIntel: {
    dir: 'workers/workspace-intel'
  },
  writeAssist: {
    dir: 'workers/write-assist'
  },
  paperRadar: {
    dir: 'workers/paper-radar'
  },
  sciModalityRouter: {
    dir: 'workers/sci-modality-router'
  },
  evidenceDag: {
    dir: 'workers/evidence-dag'
  },
  runtimeInspector: {
    dir: 'workers/runtime-inspector'
  },
  remoteExecutor: {
    dir: 'workers/remote-executor'
  },
  scientificPlotting: {
    dir: 'workers/scientific-plotting'
  },
  imageGeneration: {
    dir: 'workers/image-generation'
  },
  multiAgent: {
    dir: 'workers/multi-agent'
  },
  pptMaster: {
    dir: 'workers/ppt-master'
  },
  canvas: {
    dir: 'workers/canvas'
  },
  guiOwlComputerUse: {
    dir: 'workers/gui-owl-computer-use'
  }
}
