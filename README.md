...
SciForge 当前仓库使用自定义学术非商用许可证发布：允许学术研究、教学、复现、评估和非商业协作，不允许商业使用。发布前还需要确认源码、历史来源、资产、依赖、模型权重、服务配置和打包产物都处在可解释边界内。
...
[SciForge Academic Non-Commercial License](./LICENSE)：允许学术非商用使用，禁止商业使用。
