...
<p align="center">
  <a href="src/asset/img/code.gif">
    <img src="src/asset/img/code.gif" width="680" alt="SciForge Code 模式演示">
  </a>
</p>
...
> 致谢：感谢 Reasonix 团队提供的可运行参考。SciForge Runtime
...
Write 模式的目标是把 SciForge 从“代码/聊天工作台”扩展成真正可长期写作的桌面工作区。实现时参考了本地 `openhanako` 项目中的几个方案：
